...
Since map doesn't mutate the original array, it should be used as a value, 
stored inside a variable, passed in as a returned value inside a function 
(the most common case) and many other things. Let's learn a little bit of what this powerful function can do! 
Say we have an array of names and we want to create a new array with these names but UPPERCASED.
...
The callback is the function that the Array.map() method accepts, it can be an anonymous function or an already 
declared function with the following parameters which, by the way, you can name as you please:

1- currentValue: As the name suggest, it's the current element of the array being evaluated and waiting 
for your function to replace it with a new value in the new array (same index of course).

2- index: It equals to the numeric index of currentValue, say you are in "Anakin", 
that means index, at the time, will equal to 1.
...
["Leia", "Anakin", "Luke", "Obi Wan Kenobi"] into 
...
jediMasters
[object Array]       ["Leia","Anakin", "Luke", "Obi Wan Ken..."]
0		"Leia"
1		"Anakin"
2		"Luke"
3		"Obi Wan Kenobi"
...
jediMastersSayHi  ["My name is Leia, I'm #1","My name is Anakin, I'm #2","My name is Luke, I'm #3", "And last but not less inportant, I'm  #4 Obi Wan Kenobi"]
0				"My name is Leia, I'm #1"
1				"My name is Anakin, I'm #2"
2				"My name is Luke, I'm #3"
3				And last but not less inportant, I'm  #4 Obi Wan Kenobi
